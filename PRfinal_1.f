	...
	SUBROUTINE EN_LJ(R,N,DM,L,F,POT,D)
	 ...
	 DO I=1,N
	  DO J=I+1,N
	   ...
	   IF (D.LT.CUTOFF) THEN
	    F(I,1)=F(I,1)+(48D0*PROD/D**14D0-24D0*PROD/D**8D0)*DX
	    F(I,2)=F(I,2)+(48D0*PROD/D**14D0-24D0*PROD/D**8D0)*DY
	    F(I,3)=F(I,3)+(48D0*PROD/D**14D0-24D0*PROD/D**8D0)*DZ
	    
	    F(J,1)=F(J,1)-(48D0*PROD/D**14D0-24D0*PROD/D**8D0)*DX
	    F(J,2)=F(J,2)-(48D0*PROD/D**14D0-24D0*PROD/D**8D0)*DY
	    F(J,3)=F(J,3)-(48D0*PROD/D**14D0-24D0*PROD/D**8D0)*DZ
